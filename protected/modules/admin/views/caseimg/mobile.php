...
<div class='col-lg-12 page-title'>
	<h1 class="title">案例<?php echo $case; ?> 图片（移动端）</h1>
	
	<p>
	<a class="btn btn-primary" href="<?php echo Yii::app()->controller->createUrl('/admin/cases/admin'); ?>">案例列表</a>
	<a class="btn btn-primary" href="<?php echo Yii::app()->controller->createUrl("/admin/caseimg/pc", array("cid" => $cid)); ?>">PC端图片</a>
...
<script type="text/javascript">
	...
	var uploader = new plupload.Uploader({//创建实例的构造方法
		...
		url: "/admin/caseimg/upload2/cid/"+cid, //远程上传地址

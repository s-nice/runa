...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="/static/admin/images/favicon.png" type="image/x-icon" />    <!-- Favicon -->
		
        <!-- CORE CSS FRAMEWORK - START -->
        <link href="/static/admin/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
        <link href="/static/admin/fonts/font-awesome/css/font-awesome.css" rel="stylesheet" type="text/css"/>
    ...
    <body class=" "><!-- START TOPBAR -->
        ...
        <script src="/static/admin/js/jquery.easing.min.js" type="text/javascript"></script>
        <script src="/static/admin/plugins/bootstrap/js/bootstrap.min.js" type="text/javascript"></script> 
        
        <script src="/static/admin/plugins/perfect-scrollbar/perfect-scrollbar.min.js" type="text/javascript"></script> 
